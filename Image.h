...
namespace imaging
{
	...
	*/
	...
	//template <typename math::Vec3<float>>
	class Image: public Array<Vec3<float>> // class Image: public math::Array::Vec3<float>
	{
	public:
		// metric accessors
		...
		*/
		...
		const Vec3<float>& operator()(int x, int y) const;
